...
{
    internal class LinkUpEventFireResponse : LinkUpLogic
    {
        ...
        {
            return new byte[] { (byte)LinkUpLogicType.EventFireResponse }.Concat(BitConverter.GetBytes(Identifier)).ToArray();
        }
    }
}